					...
					<div class="property-details">
						...
						<div class="row block-9 justify-content-center mb-5">
							<div class="col-md-8 mb-md-5">
								...
								<form action="${pageContext.request.contextPath}/restaurant/ReviewModifyOk.re" class="bg-light p-5 contact-form" method="POST" name="reviewForm" enctype="multipart/form-data">
								 <input type="hidden" name="reviewNum" value="${reviewBean.getReview_num()}">
								 <input type="hidden" name="restaurantNum" value="${restaurantBean.getRestaurant_num()}">
									...
									<div class="form-group">
										<textarea name="review" id="" cols="100" rows="10"
											class="form-control">${reviewBean.getReview()}</textarea>
									</div>
									...
									<div class="col-md-12">
									  ...
									  <div class="form-group text-right">
										...
										<input type="submit" value="완료" class="btn btn-primary py-2 px-3">	
									</div>
									<!-- </div> -->
