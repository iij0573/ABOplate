	...
	<section class="hero-wrap2 hero-wrap-2 ftco-degree-bg js-fullheight" style="background-image: url('../images/main.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
            ...
            <p class="mb-3 bread" style="position: relative; top: 50px; font-size: 30px;">내 리뷰 페이지</p>
							...
							<div class="col-md-8 mb-md-5">
								...
								<form action="#" class="bg-light p-5 contact-form ">
									...
									<div class="form-group text-right">
										...
										<input type="submit" value="이전" class="btn btn-primary py-2 px-3">
									</div>
									<!-- form 태그 끝  -->
								</form>
							</div>
